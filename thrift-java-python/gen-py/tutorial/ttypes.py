...
class Var:
  ...
  thrift_spec = (
    None, # 0
    (1, TType.STRING, 'varId', None, None, ), # 1
    (2, TType.STRING, 'value', None, None, ), # 2
  )

  def __init__(self, varId=None, value=None,):
    self.varId = varId
    self.value = value
  ...
  def write(self, oprot):
    ...
    if self.varId is not None:
      oprot.writeFieldBegin('varId', TType.STRING, 1)
      oprot.writeString(self.varId)
      oprot.writeFieldEnd()
  ...
  def validate(self):
    if self.varId is None:
      raise TProtocol.TProtocolException(message='Required field varId is unset!')
...
class Row:
  ...
  thrift_spec = (
    ...
    (3, TType.MAP, 'groups', (TType.STRING,None,TType.MAP,(TType.I64,None,TType.MAP,(TType.STRING,None,TType.STRING,None))), None, ), # 3
  )

  def __init__(self, table=None, rowKey=None, groups=None,):
    self.table = table
    self.rowKey = rowKey
    self.groups = groups
  ...
  def write(self, oprot):
    ...
    if self.groups is not None:
      ...
      oprot.writeMapBegin(TType.STRING, TType.MAP, len(self.groups))
      for kiter21,viter22 in self.groups.items():
        oprot.writeString(kiter21)
        oprot.writeMapBegin(TType.I64, TType.MAP, len(viter22))
        for kiter23,viter24 in viter22.items():
  ...
  def validate(self):
    ...
    if self.rowKey is None:
      raise TProtocol.TProtocolException(message='Required field rowKey is unset!')
    return
