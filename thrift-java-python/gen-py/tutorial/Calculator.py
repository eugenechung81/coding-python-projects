...
class Client(shared.SharedService.Client, Iface):
  ...
  def getRow(self, tbl, key):
    ...
    Parameters:
     ...
     - key
    """
    self.send_getRow(tbl, key)
    return self.recv_getRow()

  def send_getRow(self, tbl, key):
  ...
  def getRows(self, tbl):
    ...
    Parameters:
     - tbl
    """
    self.send_getRows(tbl)
    return self.recv_getRows()

  def send_getRows(self, tbl):
...
class Processor(shared.SharedService.Processor, Iface, TProcessor):
  ...
  def process_getRow(self, seqid, iprot, oprot):
    ...
    iprot.readMessageEnd()
    result = getRow_result()
    result.success = self._handler.getRow(args.tbl, args.key)
  ...
  def process_getRows(self, seqid, iprot, oprot):
    ...
    iprot.readMessageEnd()
    result = getRows_result()
    result.success = self._handler.getRows(args.tbl)
...
class getRow_args:
  ...
  thrift_spec = (
    None, # 0
    (1, TType.STRING, 'tbl', None, None, ), # 1
  ...
  def write(self, oprot):
    ...
    if self.tbl is not None:
      oprot.writeFieldBegin('tbl', TType.STRING, 1)
...
class getRow_result:
  ...
  thrift_spec = (
    (0, TType.STRUCT, 'success', (Row, Row.thrift_spec), None, ), # 0
  )
...
class getRows_result:
  ...
  thrift_spec = (
    (0, TType.LIST, 'success', (TType.STRUCT,(Row, Row.thrift_spec)), None, ), # 0
  )
