...
public class Calculator {
  ...
  public interface Iface extends shared.SharedService.Iface {
     ...
     * @param key
     */
    public Row getRow(String tbl, String key) throws org.apache.thrift.TException;

    public List<Row> getRows(String tbl) throws org.apache.thrift.TException;
  ...
  public interface AsyncIface extends shared.SharedService .AsyncIface {
    ...
    public void getRow(String tbl, String key, org.apache.thrift.async.AsyncMethodCallback resultHandler) throws org.apache.thrift.TException;

    public void getRows(String tbl, org.apache.thrift.async.AsyncMethodCallback resultHandler) throws org.apache.thrift.TException;
  ...
  public static class Client extends shared.SharedService.Client implements Iface {
    ...
    public void send_getRow(String tbl, String key) throws org.apache.thrift.TException
    {
    ...
    public Row recv_getRow() throws org.apache.thrift.TException
    {
    ...
    public void send_getRows(String tbl) throws org.apache.thrift.TException
    {
    ...
    public List<Row> recv_getRows() throws org.apache.thrift.TException
    {
  ...
  public static class AsyncClient extends shared.SharedService.AsyncClient implements AsyncIface {
    ...
    public void getRow(String tbl, String key, org.apache.thrift.async.AsyncMethodCallback resultHandler) throws org.apache.thrift.TException {
      checkReady();
      getRow_call method_call = new getRow_call(tbl, key, resultHandler, this, ___protocolFactory, ___transport);
    ...
    public static class getRow_call extends org.apache.thrift.async.TAsyncMethodCall {
      private String tbl;
      private String key;
      public getRow_call(String tbl, String key, org.apache.thrift.async.AsyncMethodCallback resultHandler, org.apache.thrift.async.TAsyncClient client, org.apache.thrift.protocol.TProtocolFactory protocolFactory, org.apache.thrift.transport.TNonblockingTransport transport) throws org.apache.thrift.TException {
      ...
      public Row getResult() throws org.apache.thrift.TException {
    ...
    public void getRows(String tbl, org.apache.thrift.async.AsyncMethodCallback resultHandler) throws org.apache.thrift.TException {
      checkReady();
      getRows_call method_call = new getRows_call(tbl, resultHandler, this, ___protocolFactory, ___transport);
      this.___currentMethod = method_call;
      ___manager.call(method_call);
    }
    ...
    public static class getRows_call extends org.apache.thrift.async.TAsyncMethodCall {
      private String tbl;
      public getRows_call(String tbl, org.apache.thrift.async.AsyncMethodCallback resultHandler, org.apache.thrift.async.TAsyncClient client, org.apache.thrift.protocol.TProtocolFactory protocolFactory, org.apache.thrift.transport.TNonblockingTransport transport) throws org.apache.thrift.TException {
        super(client, protocolFactory, transport, resultHandler, false);
        this.tbl = tbl;
      }
      ...
      public List<Row> getResult() throws org.apache.thrift.TException {
        if (getState() != org.apache.thrift.async.TAsyncMethodCall.State.RESPONSE_READ) {
          throw new IllegalStateException("Method call not finished!");
        }
        org.apache.thrift.transport.TMemoryInputTransport memoryTransport = new org.apache.thrift.transport.TMemoryInputTransport(getFrameBuffer().array());
  ...
  public static class Processor<I extends Iface> extends shared.SharedService.Processor<I> implements org.apache.thrift.TProcessor {
    ...
    public static class getRow<I extends Iface> extends org.apache.thrift.ProcessFunction<I, getRow_args> {
      ...
      public getRow_result getResult(I iface, getRow_args args) throws org.apache.thrift.TException {
        getRow_result result = new getRow_result();
        result.success = iface.getRow(args.tbl, args.key);
        return result;
      }
    }
    ...
    public static class getRows<I extends Iface> extends org.apache.thrift.ProcessFunction<I, getRows_args> {
      ...
      public getRows_result getResult(I iface, getRows_args args) throws org.apache.thrift.TException {
        getRows_result result = new getRows_result();
        result.success = iface.getRows(args.tbl);
        return result;
      }
    }
  ...
  public static class AsyncProcessor<I extends AsyncIface> extends shared.SharedService.AsyncProcessor<I> {
    ...
    public static class getRow<I extends AsyncIface> extends org.apache.thrift.AsyncProcessFunction<I, getRow_args, Row> {
      public getRow() {
        super("getRow");
      }
      ...
      public AsyncMethodCallback<Row> getResultHandler(final AsyncFrameBuffer fb, final int seqid) {
        final org.apache.thrift.AsyncProcessFunction fcall = this;
        return new AsyncMethodCallback<Row>() { 
          public void onComplete(Row o) {
            getRow_result result = new getRow_result();
            result.success = o;
            try {
      ...
      public void start(I iface, getRow_args args, org.apache.thrift.async.AsyncMethodCallback<Row> resultHandler) throws TException {
        iface.getRow(args.tbl, args.key,resultHandler);
      }
    }

    public static class getRows<I extends AsyncIface> extends org.apache.thrift.AsyncProcessFunction<I, getRows_args, List<Row>> {
      public getRows() {
        super("getRows");
      }
      ...
      public AsyncMethodCallback<List<Row>> getResultHandler(final AsyncFrameBuffer fb, final int seqid) {
        final org.apache.thrift.AsyncProcessFunction fcall = this;
        return new AsyncMethodCallback<List<Row>>() { 
          public void onComplete(List<Row> o) {
            getRows_result result = new getRows_result();
            result.success = o;
            try {
              fcall.sendResponse(fb,result, org.apache.thrift.protocol.TMessageType.REPLY,seqid);
      ...
      public void start(I iface, getRows_args args, org.apache.thrift.async.AsyncMethodCallback<List<Row>> resultHandler) throws TException {
        iface.getRows(args.tbl,resultHandler);
      }
    }
  ...
  public static class getRow_args implements org.apache.thrift.TBase<getRow_args, getRow_args._Fields>, java.io.Serializable, Cloneable, Comparable<getRow_args>   {
    ...
    private static final org.apache.thrift.protocol.TField TBL_FIELD_DESC = new org.apache.thrift.protocol.TField("tbl", org.apache.thrift.protocol.TType.STRING, (short)1);
    ...
    public getRow_args setTbl(String tbl) {
      this.tbl = tbl;
      return this;
    }
    ...
    public getRow_args setKey(String key) {
      this.key = key;
      return this;
    }
  ...
  public static class getRow_result implements org.apache.thrift.TBase<getRow_result, getRow_result._Fields>, java.io.Serializable, Cloneable, Comparable<getRow_result>   {
    ...
    public getRow_result setSuccess(Row success) {
      this.success = success;
      return this;
    }
  ...
  public static class getRows_args implements org.apache.thrift.TBase<getRows_args, getRows_args._Fields>, java.io.Serializable, Cloneable, Comparable<getRows_args>   {
    ...
    public getRows_args setTbl(String tbl) {
      this.tbl = tbl;
      return this;
    }
  ...
  public static class getRows_result implements org.apache.thrift.TBase<getRows_result, getRows_result._Fields>, java.io.Serializable, Cloneable, Comparable<getRows_result>   {
    ...
    public List<Row> success; // required
    ...
    public getRows_result(getRows_result other) {
      if (other.isSetSuccess()) {
        List<Row> __this__success = new ArrayList<Row>(other.success.size());
        for (Row other_element : other.success) {
          __this__success.add(new Row(other_element));
        }
    ...
    public java.util.Iterator<Row> getSuccessIterator() {
      return (this.success == null) ? null : this.success.iterator();
    }

    public void addToSuccess(Row elem) {
      if (this.success == null) {
        this.success = new ArrayList<Row>();
      }
      this.success.add(elem);
    }

    public List<Row> getSuccess() {
      return this.success;
    }

    public getRows_result setSuccess(List<Row> success) {
      this.success = success;
      return this;
    }
              ...
              if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
                {
                  ...
                  struct.success = new ArrayList<Row>(_list30.size);
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, getRows_result struct) throws org.apache.thrift.TException {
        ...
        if (struct.success != null) {
          oprot.writeFieldBegin(SUCCESS_FIELD_DESC);
          {
            ...
            for (Row _iter33 : struct.success)
            {
              _iter33.write(oprot);
            }
            oprot.writeListEnd();
        ...
        if (struct.isSetSuccess()) {
          {
            ...
            for (Row _iter34 : struct.success)
            {
              _iter34.write(oprot);
            }
          }
        ...
        if (incoming.get(0)) {
          {
            ...
            struct.success = new ArrayList<Row>(_list35.size);
